...
#
# file: 07_random_quadratic_simulations.R
# 
...
# For code testing on a local machine, run the following two lines
# nodes <- 1
# data <- data[1:200]
...
glmer_theta <- c(glmer_beta, glmer_sd, glmer_cor, glmer_Sigma_D, glmer_Sigma_L[lower.tri(glmer_Sigma_L, diag=FALSE)])
