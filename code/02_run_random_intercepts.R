...
# 
# file: 02_run_random_intercepts.R
#
...
# This optimization will take a while (approximately 1.5 hours) because we set the tolerance very small by 
# default
